        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
          {featured.map((p, i) => (
            <motion.a
              ...
              className={`group flex min-h-[18rem] flex-col rounded-2xl border border-white/[0.07] bg-white/[0.035] p-7 backdrop-blur-md ${TILE_LINK_HOVER} hover:border-white/[0.12] hover:bg-white/[0.055] sm:min-h-[20rem] sm:p-9 md:min-h-[22rem]`}
            >
              <span
              ...
              <span
                className="mt-6 text-[10px] uppercase tracking-[0.18em] text-white/40 transition-colors duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:text-white/55"
                style={{ fontFamily: mono }}
              >
                repository →
              </span>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:mt-8 sm:grid-cols-2 sm:gap-5">
          {supporting.map((p, i) => (
            ...
            >
              ...
              <span
                className="mt-4 text-[9px] uppercase tracking-[0.16em] text-white/35 transition-colors duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:text-white/50"
                style={{ fontFamily: mono }}
              >
                open →
              </span>
