...
export function SiteNav({ onPrintResume }: SiteNavProps) {
  return (
    <div className="screen-only pointer-events-none fixed left-0 right-0 top-0 z-[70] hidden sm:flex justify-end p-5 sm:p-6 [font-family:var(--font-jetbrains-mono),monospace]">
