          ...
          >
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 5, marginTop: 4 }}>
                {badges.map((badge) => {
                  const { solid, label } = badge;
                  const href =
                    "href" in badge && typeof badge.href === "string"
                      ? badge.href
                      : undefined;
                  const pillStyle = {
                    fontFamily: mono,
                  ...
                  return href ? (
                    <a
                      ...
                      className={
                        solid
                          ? `${TILE_LINK_HOVER} hover:brightness-110`
                          : `${TILE_LINK_HOVER} hover:bg-[rgba(255,172,46,0.16)]`
                      }
                    >
                      {label}
                    </a>
                    ...
                    <span
                      ...
                      className={
                        solid
                          ? "cursor-default transition-[filter] duration-200 ease-out hover:brightness-110"
                          : "cursor-default bg-transparent transition-colors duration-200 ease-out hover:bg-[rgba(255,172,46,0.14)]"
                      }
                    >
                      {label}
                    </span>
