...
export default function Ascii({
  ...
  return (
    ...
    >
      ...
      {ready && track && (
        <div
          className="pointer-events-auto absolute bottom-6 right-6 z-[2] max-w-[16rem] text-right [font-family:var(--font-jetbrains-mono),monospace]"
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="block text-base leading-snug underline decoration-transparent underline-offset-2 transition-colors hover:decoration-white/35"
          >
            {track.artist}
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-0.5 block text-sm leading-snug underline decoration-transparent underline-offset-2 transition-colors hover:decoration-white/35"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-1 inline-block text-[10px] uppercase tracking-[0.22em] underline decoration-dotted underline-offset-4 transition-opacity hover:opacity-90"
