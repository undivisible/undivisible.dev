...
export function Info({
  ...
  const clockPanel = (
    <div
      ...
      className="absolute left-0 top-20 z-20 w-fit text-[10px] uppercase tracking-[0.18em] [font-family:var(--font-jetbrains-mono),monospace] sm:text-[11px] sm:tracking-[0.22em] lg:top-24"
      ...
      {socials.map((social) => {
        ...
        return (
          <a
            ...
            className="relative block h-8 min-w-0 w-full overflow-hidden rounded-full px-2 sm:px-2.5"
            onMouseEnter={() => setHoveredPill(social.name)}
            onMouseLeave={() => setHoveredPill(null)}
          >
            <div
              className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full px-1 sm:px-2"
              style={pillStyle}
            >
              <span
                className="font-mono text-[11px] leading-none transition-transform duration-300 sm:text-xs"
                style={{
              ...
              <span
                className={`pointer-events-none absolute inset-x-2 bottom-1 truncate text-center font-mono text-[8px] leading-tight transition-all duration-300 sm:text-[9px] ${
                  active ? "opacity-100" : "opacity-0"
                }`}
                style={{
                  transform: active ? "translateY(0)" : "translateY(0.35rem)",
  ...
  const heroBlock = (
    <div className="w-full">
      <div className="space-y-3">
        <h1 className="font-serif text-base leading-tight">
  ...
  return (
    <div className="relative w-full" style={{ color: "var(--page-text)" }}>
      ...
      <section
        id="start"
        className="scroll-mt-28 relative flex min-h-svh snap-start snap-always flex-col justify-end pb-24 pt-32 sm:pb-28 sm:pt-40"
      >
        {clockPanel}
        <div className="relative z-10 mx-auto w-full max-w-2xl">
          <p className="mb-3 text-[10px] uppercase tracking-[0.28em] text-white/35 font-mono">
            undivisible.dev
          </p>
          {heroBlock}
        </div>
      ...
      >
        <div className="mx-auto w-full max-w-3xl px-5 sm:px-8 lg:max-w-none lg:px-0">
          <h2 className="mb-12 font-serif text-[clamp(1.75rem,5vw,2.75rem)] font-normal leading-[1.05] tracking-[-0.03em]">
            work
          </h2>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {tidbits.map((tidbit) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`rounded-2xl border border-white/[0.06] bg-white/[0.03] p-4 backdrop-blur-sm transition-colors hover:border-white/[0.1] hover:bg-white/[0.045] ${
      ...
      >
        <div className="mx-auto w-full max-w-3xl px-5 sm:px-8 lg:max-w-none lg:px-0">
          ...
          <div className="space-y-16 sm:space-y-20">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {resumeInterests.map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-white/[0.07] px-3 py-1.5 text-[12px] text-white/55"
                  >
                    {item}
                  </span>
                ))}
            ...
            <div
              id="contact"
              className="scroll-mt-28 snap-start snap-always rounded-2xl border border-white/[0.07] bg-white/[0.035] p-6 backdrop-blur-md sm:p-8"
            >
              <h3 className="mb-6 text-[11px] uppercase tracking-[0.2em] text-white/40 font-mono">
                contact
              </h3>
...
function UtilitiesBlock({
  ...
  return (
    <div className="space-y-4">
      <p className="text-[11px] uppercase tracking-[0.18em] font-mono text-white/40">
        libraries & tools
      </p>
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        {utilitiesFiltered.map((product) => (
          <a
            key={product.key}
            href={product.href}
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-3 text-left text-[var(--page-text)] backdrop-blur-sm transition-colors hover:border-white/[0.1] hover:bg-white/[0.045] sm:p-4"
          >
...
function MainProjectCard({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`group relative flex min-h-[11rem] w-full flex-col rounded-2xl border border-white/[0.06] bg-white/[0.03] p-4 text-[var(--page-text)] backdrop-blur-sm transition-colors hover:border-white/[0.12] hover:bg-white/[0.055] sm:min-h-[12rem] sm:p-5 ${
        isMobile ? "max-w-full" : ""
      }`}
    >
      ...
      <div
        className={`mt-3 text-[10px] uppercase tracking-[0.18em] font-mono transition-opacity ${
