...
export function Page2() {
  const cases = [
    ...
    },
    {
      ...
      body: "Built the Studio of Optimisations site as a live automation intake surface: rotating problem prompts, voice entry, booking handoff, MCP-backed tool streaming, and a Pava onboarding path that carries context forward instead of restarting the user.",
      badges: [{ solid: false, label: "optimisations.studio" }],
    },
    {
      n: "05",
      tag: "Pava · Next.js · Supabase · Stripe · Gemini · Late API",
      title: "Pava — AI Content Marketing Platform",
      body: "Built an AI marketing product with chat onboarding, idea generation, AI-negotiated pricing, content calendar, analytics, voice, team workspaces, agency client management, and crossposting to 13+ social platforms.",
      badges: [{ solid: false, label: "pava.studio" }],
    },
    {
      n: "06",
