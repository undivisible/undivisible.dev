...
const cases = [
  ...
  },
  {
    ...
    body: "Voice entry, booking, MCP-backed tool streaming, status updates, and Pava onboarding handoff at optimisations.studio.",
    badge: "optimisations.studio",
    solid: false,
  },
  {
    metric: "13+",
    tag: "Pava · Content Marketing",
    title: "AI marketing platform",
    body: "Chat onboarding, idea generation, pricing, calendar, analytics, voice, agency management, and crossposting to 13+ platforms.",
    badge: "pava.studio",
    solid: false,
  },
  {
